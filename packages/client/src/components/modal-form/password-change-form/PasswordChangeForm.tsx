...
import { TModalForm } from "components/modal-form/ModalForm";

type TPasswordChangeForm = Pick<TModalForm, "isOpen" | "setIsOpen"> &
  Partial<{ className: string }>;

export const PasswordChangeForm: React.FC<TPasswordChangeForm> = (props: TPasswordChangeForm) => {
  const {
    control,
    handleSubmit,
